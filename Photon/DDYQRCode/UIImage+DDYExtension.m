...
#pragma mark 压缩到小于某个数值
+ (UIImage *)ddy_CompressImage:(UIImage *)image toByte:(NSUInteger)maxLength {
    // Compress by quality
...
//        DDYInfoLog(@"tu pian da xiao \nCompress:%lu-%d-%f", data.length,i,compression);
    }
