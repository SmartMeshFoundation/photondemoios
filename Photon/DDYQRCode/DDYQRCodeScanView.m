...
- (void)setupContentView {
    ...
    tipLabel.text = DDYLocalStr(@"ScanTip");
    tipLabel.font = [UIFont systemFontOfSize:12];
    [self addSubview:tipLabel];
    
    // 闪光灯
    DDYButton *torchBtn = [DDYButton customDDYBtn];
    torchBtn.frame = CGRectMake(scanX, DDYSCREENH-65-TabBarHeight, scanW, 40);
    [torchBtn setImage:[UIImage imageNamed:@"smtWaller_shoudiantongno"] forState:UIControlStateNormal];
    [torchBtn setImage:[UIImage imageNamed:@"smtWaller_shoudiantongno"] forState:UIControlStateSelected];
    [torchBtn setTitle:DDYLocalStr(@"ScanLightUp") forState:UIControlStateNormal];
    [torchBtn setTitle:DDYLocalStr(@"ScanLightOff") forState:UIControlStateSelected];
//    torchBtn.titleLabel.font = NABDFont(15);
    torchBtn.titleLabel.font = [UIFont boldSystemFontOfSize:15];
