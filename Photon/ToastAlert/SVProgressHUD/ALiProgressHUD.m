...
//
//            // 豆电雨添加，不旋转
//            [weakSelf configHUDOrientation:UIInterfaceOrientationPortrait];
//            weakSelf.lastOrientation = UIInterfaceOrientationPortrait;
//            NSLog(@"%tu=-------%tu",UIInterfaceOrientationPortrait, weakSelf.lastOrientation);
//
